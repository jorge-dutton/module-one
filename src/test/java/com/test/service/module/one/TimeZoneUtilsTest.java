...
public class TimeZoneUtilsTest {
	...
	public void testGMTSpanishSummerTimeFromPortugalTimezone() {
		...
		assertEquals("Spanish time in summer should has ["+TimeZoneUtilsTest.GMTplus01+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTplus01 , gmtTxt);
	}
	...
	public void testGMTSpanishWinterTime2() {
		...
		assertEquals("Spanish time in winter  should has ["+TimeZoneUtilsTest.GMTplus02+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTplus02 , gmtTxt);		
	}
	...
	public void testGMTSpanishSummerTime() {
		...
		assertEquals("Spanish time in summer should has ["+TimeZoneUtilsTest.GMTplus02+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTplus02 , gmtTxt);
	}
	...
	public void testGMTSpanishWinterTime() {
		...
		assertEquals("Spanish time in winter  should has ["+TimeZoneUtilsTest.GMTplus01+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTplus01 , gmtTxt);		
	}
	...
	public void testGMTPortugalWinterTime() {
		...
		String gmtTxt =  TimeZoneUtils.getGMTOffset(datewinter);
		assertEquals("Spanish time in winter  should has ["+TimeZoneUtilsTest.GMTstandart+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTstandart , gmtTxt);		
	}
	...
	public void testGMTSaoPauloSummerTime() {
		Calendar dateSummer = getSummerDate(TimeZone.getTimeZone(AMERICA_SAOPAULO_CALENDAR)); 
		String gmtTxt =  TimeZoneUtils.getGMTOffset(dateSummer);
		assertEquals("Spanish time in summer should has ["+TimeZoneUtilsTest.GMTminus03+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTminus03 , gmtTxt);
	}
	...
	public void testGMTSaoPauloWinterTime() {
		...
		String gmtTxt =  TimeZoneUtils.getGMTOffset(datewinter);
		assertEquals("Spanish time in winter  should has ["+TimeZoneUtilsTest.GMTminus02+"] instead of ["+gmtTxt+"]", TimeZoneUtilsTest.GMTminus02 , gmtTxt);		
	}
